...
const SearchUser = ({ user }) => {
  ...
  const handlePublicarComentario = useCallback(async (idPublicacion) => {
    await dispatch(comentar({ comentario: nuevosComentarios[idPublicacion], idPublicacion }));
    setNuevosComentarios(prevComentarios => ({ ...prevComentarios, [idPublicacion]: '' }));
    dispatch(traerPublicaciones());
  }, [dispatch, nuevosComentarios]);
                  ...
                  <>
                    ...
                    <div className='flex'>
                      ...
                      <button
                        ...
                        onClick={() => handlePublicarComentario(publicacion.idPublicacion)}
                      >
